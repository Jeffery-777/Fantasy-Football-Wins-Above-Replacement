...
#need to load the rds files (3) to then compute the combination of them.
data <- scrape1 %>%
    full_join(scrapekickers, by = c("Player" = "Player")) %>%
    full_join(scrapedst, by = c("Player" = "Team"))
...
saveRDS(data, file = "Fantasy Football Complete 2010_2019.rds")
```
